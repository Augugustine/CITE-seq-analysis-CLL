...
CLL_merged <- subset(CLL_merged, subset = qc.pass == "pass")
...
plot1<-DimPlot(CLL_qc, group.by = "label", cols = c("live" = "grey50", "dead" = "red")) + ggtitle(str_wrap(title, width = 50)) + theme(plot.title = element_text(size = 10, hjust = 0.5))
plot1
