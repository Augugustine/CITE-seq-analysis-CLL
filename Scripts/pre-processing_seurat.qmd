...
DimPlot(CLL_merged_sctransform, reduction = "umap", label = TRUE, repel = TRUE, label.size = 2.5) + NoLegend() + ggtitle(str_wrap(title, width = 50)) + theme(plot.title = element_text(size = 10, hjust = 0.5))
...
DimPlot(CLL_merged, reduction = "umap", label = TRUE, repel = TRUE, label.size = 2.5) + NoLegend() + ggtitle(str_wrap(title, width = 50)) + theme(plot.title = element_text(size = 10, hjust = 0.5))
...
```{r}
namepath=paste0("./CLL_LogNorm_", params$patient, "_seurat.rds")
saveRDS(CLL_merged, file = namepath)

namepath=paste0("./CLL_SCT_", params$patient, "_seurat.rds")
saveRDS(CLL_merged_sctransform, file = namepath)
```
