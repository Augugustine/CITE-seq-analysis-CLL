...
DimPlot(CLL_multiplet, group.by = "Doublet_Status", cols = c("Other" = "grey50", "Doublet" = "red")) + ggtitle(str_wrap(title, width = 50)) + theme(plot.title = element_text(size = 10, hjust = 0.5))
```
...
plot1<-DimPlot(CLL_qc, group.by = "passed.qc", cols = c("TRUE" = "grey50", "FALSE" = "red")) + ggtitle(str_wrap(title, width = 50)) + theme(plot.title = element_text(size = 10, hjust = 0.5))
plot1
