...
The tool used is scDblFinder, is important to do this step on empty drops filtered data. The input data does not contain any empty drops, but hasn't been further filtered.
The tool scDblFinder can be applied on aggregated data.
