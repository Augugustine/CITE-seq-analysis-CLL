...
Steps of this pre-processing using Seurat and DoubletFinder (all days merged)

-   Downloading the data and creating one Seurat object per day. Using filtered data without empty drops (from CellRanger 10X Genomics or CellBender)
...
```{r}
#| include: false
seurat <- load_data_filtered(params$patient, c(1,4,8,11,14), base_dir = "~/Documents/Singlecell-R/", "filtered_feature_bc_matrix.h5")
...
```{r}
namepath=paste0("./CLL_", params$patient, "merged.rds")
