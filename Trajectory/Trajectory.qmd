...
```{r}
# Pseudotime en couleur
plot_cells(cds, color_cells_by = "pseudotime")

# Colorer par timepoint (tes 5 temps)
plot_cells(cds, color_cells_by = "timepoint")

# Colorer par clusters Seurat
