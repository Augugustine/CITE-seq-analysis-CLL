...
params: 
  patient: "P2"
  patientbis: "P3"
  fileP2: "CLL_P1_seurat_reduit.rds"
  fileP3: "CLL_manual_annotated_valiDrops_P2.rds"
  type: "valiDrops"
format: html
editor: visual
---
...
plotumap<-DimPlot(data_p2, group.by="SingleR_fine", reduction = "umap", label = TRUE, repel = TRUE, label.size = 4) + ggtitle(str_wrap(title, width = 100)) + theme(plot.title = element_text(size = 15, hjust = 0.5), legend.text = element_text(size = 12))
plotumap
ggsave(paste0(params$type,"_bridge_SingleR_", params$patient, ".jpeg"), plotumap, width = 3000,
