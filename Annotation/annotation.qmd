...
Récupérer le seurat object (ARN et ADT) mais annation en utilisant seulement les ARN. l'object doit avoir été filtrés (cellules et gènes) mais pas plus. Puis on lui applique une normalization comme celui de la référence utilisé () donc ici SCTransform puis une ACP
