...
plotumap<-DimPlot(data_annotated, reduction = "umap") + ggtitle(str_wrap(title, width = 50)) + theme(plot.title = element_text(size = 10, hjust = 0.5))
plotumap
...
plot1<-DimPlot(data_annotated, reduction = "umap", split.by = "timepoint") + ggtitle(str_wrap(title, width = 50)) + theme(plot.title = element_text(size = 10, hjust = 0.5))
plot1
...
plotwnn <- DimPlot(data_annotated, reduction = 'wnn.umap', label = TRUE, repel = TRUE, label.size = 2.5) + 
...
plot1<-TSNEPlot(data_annotated) + ggtitle(str_wrap(title, width = 50)) + theme(plot.title = element_text(size = 10, hjust = 0.5))
plot1
...
DimPlot(data_annotated, reduction = "isomap") + ggtitle(str_wrap(title, width = 50)) + theme(plot.title = element_text(size = 10, hjust = 0.5))
```
